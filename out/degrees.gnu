...
plot 'deg_1.0E-5.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes 

set origin 0.33333,0.75
set title  "degree distribution for theta = 2.0E-5"
plot 'deg_2.0E-5.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes

set origin 0.66666,0.75
set title  "degree distribution for theta = 5.0E-5"
plot 'deg_5.0E-5.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes


set origin 0.0,0.5  
set title  "degree distribution for theta = 1.0E-4"
plot 'deg_1.0E-4.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes 

set origin 0.33333,0.5
set title  "degree distribution for theta = 2.0E-4"
plot 'deg_2.0E-4.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes

set origin 0.66666,0.5
set title  "degree distribution for theta = 5.0E-4"
plot 'deg_5.0E-4.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes


set origin 0.0,0.25  
set title  "degree distribution for theta = 1.0E-3"
plot 'deg_0.0010.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes 

set origin 0.33333,0.25
set title  "degree distribution for theta = 2.0E-3"
plot 'deg_0.0020.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes

set origin 0.66666,0.25
set title  "degree distribution for theta = 5.0E-3"
plot 'deg_0.0050.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes


set origin 0.0,0.0
set title  "degree distribution for theta = 1.0E-2"
plot 'deg_0.01.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes 

set origin 0.33333,0.0
set title  "degree distribution for theta = 2.0E-2"
plot 'deg_0.02.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes

set origin 0.66666,0.0
set title  "degree distribution for theta = 5.0E-2"
plot 'deg_0.05.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes
